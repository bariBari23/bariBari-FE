...
import icon from '../assets/css_sprites_final.png';
...
// '>' 모양 아이콘 (주황색)
export const RPointerBigIcon = styled.div`
    width: 24px;
    height: 24px;
    background-image: url(${icon});
...
// '>' 모양 아이콘 (회색 15*15)
export const RPointerMedIcon = styled.div`
    width: 15px;
    height: 15px;
    background-image: url(${icon});
...
// '>' 모양 아이콘 (회색 8*12)
export const RPointerMiniIcon = styled.div`
    width: 8px;
    height: 12px;
    background-image: url(${icon});
...
//빈 하트 아이콘 (18*18)
export const EmptyHeartBigIcon = styled.div`
    width: 18px;
    height: 18px;
    background-image: url(${icon});
...
//채워진 하트 아이콘 (19*18)
export const FilledHeartBigIcon = styled.div`
    width: 19px;
    height: 18px;
    background-image: url(${icon});
