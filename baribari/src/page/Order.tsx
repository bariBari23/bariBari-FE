    ...
    return(
        <Container>
            ...
            <InsideBox>
                ...
                <div style={{fontSize: '18px', fontWeight: '700', lineHeight: '28px', marginBottom: '20px'}}>결제 수단</div>
                <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <div style={{display: 'flex'}}><CheckBox type = 'radio' name='pay' value = '8'/><TimeBox>카카오페이</TimeBox></div>
                    <div style={{display: 'flex'}}><CheckBox type = 'radio' name='pay' value = '8'/><TimeBox>무통장 입금</TimeBox></div>
                    <div style={{display: 'flex'}}><CheckBox type = 'radio' name='pay' value = '8'/><TimeBox>현장 결제</TimeBox></div>
                </div>
                </InfoBox>
